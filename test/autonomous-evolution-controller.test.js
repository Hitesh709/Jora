...
test("autonomous evolution remains pending approval when governance is enabled",async()=>{
  const controller=new AutonomousEvolutionController({
    generationEngine:{async generate(){return {best:{candidate:{version:"v2",evaluation:{score:0.9},security:{passed:true},tests:{passed:true}}},candidates:[{candidate:{version:"v2",evaluation:{score:0.9},security:{passed:true},tests:{passed:true}}]};}},
