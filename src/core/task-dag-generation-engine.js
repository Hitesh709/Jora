export class TaskDAGGenerationEngine {
  ...
  generate({specification,architecture}={}) {
    ...
    const verification=add("Verify product","Execute tests and acceptance checks against the implementation",[components[4]?.id].filter(Boolean),[implementation],"qa-engineer",["Automated tests pass","Acceptance criteria pass"]);
