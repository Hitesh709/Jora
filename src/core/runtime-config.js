export function runtimeConfig(env=process.env){
  return {
    ...
    search:{provider:env.JORA_SEARCH_PROVIDER||"auto",apiKey:env.JORA_SEARCH_API_KEY||env.TAVILY_API_KEY||env.BRAVE_SEARCH_API_KEY,endpoint:env.JORA_SEARCH_ENDPOINT,timeoutMs:Number(env.JORA_SEARCH_TIMEOUT_MS||15000),maxResults:Number(env.JORA_SEARCH_MAX_RESULTS||8)},
